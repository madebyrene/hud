...
RegisterNetEvent('hud:client:LoadMap', function()
    ...
    if Menu.isToggleMapShapeChecked == 'square' then
        ...
        SetMinimapComponentPosition('minimap', 'L', 'B', 0.00 + minimapOffset, -0.014, 0.1400, 0.15)
        ...
        -- 0.262 = map stretched
        -- 0.315 = map shorten
        -- SetMinimapComponentPosition('minimap_blur', 'L', 'B', -0.01 + minimapOffset, 0.059, 0.230, 0.260)
        --
